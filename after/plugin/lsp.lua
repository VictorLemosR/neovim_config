...
lsp.on_attach(function(client, bufnr)
  ...
  vim.keymap.set("n", KEYS.workspace_symbol, function() vim.lsp.buf.workspace_symbol() end, opts)
  vim.keymap.set("n", KEYS.open_float, function() vim.diagnostic.open_float() end, opts)
  vim.keymap.set("n", KEYS.go_to_next, function() vim.diagnostic.goto_next() end, opts)
  vim.keymap.set("n", KEYS.go_to_prev, function() vim.diagnostic.goto_prev() end, opts)
  vim.keymap.set("n", KEYS.code_action, function() vim.lsp.buf.code_action() end, opts)
  vim.keymap.set("n", KEYS.references, function() vim.lsp.buf.references() end, opts)
  vim.keymap.set("n", KEYS.rename, function() vim.lsp.buf.rename() end, opts)
  vim.keymap.set("i", KEYS.signature_help, function() vim.lsp.buf.signature_help() end, opts)
end)
